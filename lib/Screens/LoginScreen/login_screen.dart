                  ...
                  BlocConsumer<LoginBloc, LoginState>(
                    listener: (context, loginState) async {
                      if (loginState.isCompleted) {
                        if (loginState.model?.message == 'User is not verified') {
                          AlertUtils.showToast(loginState.model?.message ?? '', context, AnimatedSnackBarType.error);
                          Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => OTPVerificationScreen(
                                        ...
                                        userId: loginState.model?.result?.id,
                                      )),
                              (route) => false);
                          return;
                        }
