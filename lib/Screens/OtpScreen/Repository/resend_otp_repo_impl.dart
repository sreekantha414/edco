...
import 'package:award_maker/Screens/OtpScreen/Repository/resend_otp_repo.dart';
...
class ReSendOtpRepositoryImpl extends ReSendOtpRepository {
  ...
  @override
  Future<ApiResponse<LoginModel>> reSendOtp(id, data) async {
    try {
      final response = await _dio.patch(APIConstants.reSendOtp, data: data);
